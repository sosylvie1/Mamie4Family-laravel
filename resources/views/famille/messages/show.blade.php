...
@section('title', 'Lecture du message - Famille | Mamie4Family')
@section('description', "Consultation et réponse à un message dans l’espace Famille.")
...
@endif
    ...
    <div class="mt-6" id="reply-form">
        ...
        <form action="{{ route('famille.messages.store') }}" method="POST" class="space-y-4 max-w-lg">
            @csrf
